    ...
    Spec: EthereumHardforks,
{
    ...
    pub fn apply_blockhashes_contract_call(
        ...
        let _span = tracing::debug_span!("eip2935 blockhashes").entered();
    ...
    pub fn apply_beacon_root_contract_call(
        ...
        let _span = tracing::debug_span!("eip4788 beacon root").entered();
        let result_and_state =
    ...
    pub fn apply_withdrawal_requests_contract_call(
        ...
        let _span = tracing::debug_span!("eip7002 withdrawal requests").entered();
    ...
    pub fn apply_consolidation_requests_contract_call(
        ...
        let _span = tracing::debug_span!("eip7251 consolidation requests").entered();
